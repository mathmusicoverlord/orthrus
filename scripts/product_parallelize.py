...
python product_parallelize.py classify.py --exp_params /hdd/orthrus/test_data/Iris/Experiments/classify_setosa_versicolor_svm/classify_setosa_versicolor_svm_params.py
